...
///
- (void)addProfileValue:(NSString * _Nonnull)property value:(NSString * _Nonnull)value;
...
///
- (void)addProfileValues:(NSString * _Nonnull)property values:(NSArray<NSString *> * _Nonnull)values;
...
///
- (void)setProfileValue:(NSString * _Nonnull)name value:(NSString * _Nonnull)value;
...
///
- (void)incrementProfileValue:(NSString * _Nonnull)property value:(NSString * _Nonnull)value;
...
///
- (void)setMobileAdId:(NSString * _Nullable)mobileAdId;
...
///
- (void)setProfileValues:(NSString * _Nonnull)name values:(NSArray<NSString *> * _Nonnull)values;
...
///
/// returns:
/// Results when it is connected, false if incorrect.
- (BOOL)setURLWithUrl:(NSURL * _Nonnull)url SWIFT_WARN_UNUSED_RESULT;
...
///
- (void)addConsentedObjective:(NSString * _Nonnull)objectiveId;
...
///
- (void)addRefusedObjective:(NSString * _Nonnull)objectiveId;
...
///
- (void)setConsentedObjectives:(NSArray<NSString *> * _Nonnull)objectiveIds;
...
///
- (void)setRefusedObjectives:(NSArray<NSString *> * _Nonnull)objectiveIds;
/// Update the profile
/// <h4>Example</h4>
/// <pre&gt:
/// // Swift:
...
/// </pre&gt:
- (void)updateProfile;
/// Update the profile with completion handler
/// <h4>Example</h4>
/// <pre&gt:
/// // Swift:
/// let hobbies: [String] = client.updateProfile()
...
/// NSArray* hobbies = [client updateProfile];
/// </pre&gt:
- (void)updateProfileWithCompletion:(void (^ _Nullable)(void))completion;
...
/// \param data A map with data for the event.
///
- (void)createEvent:(NSString * _Nonnull)eventType data:(NSDictionary<NSString *, id> * _Nullable)data completion:(void (^ _Nullable)(void))completion;
/// Registers an event of the specified type with the given properties. For a "PAGEVIEW" event a screen name can be
/// passed, so interactions can be restricted on the where tab in BlueConic.
/// For a "VIEW", "CLICK" or "CONVERSION" event an interactionId should be passed to register the event for.
/// <h4>Example</h4>
...
SWIFT_CLASS("_TtC15BlueConicClient21BlueConicEventFactory")
@interface BlueConicEventFactory : NSObject
...
///
- (void)publish:(Event * _Nonnull)event;
