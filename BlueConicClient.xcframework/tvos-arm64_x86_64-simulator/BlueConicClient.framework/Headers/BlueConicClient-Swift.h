...
/// <ul>
///   <li>
///     If the event was initialized with a custom name using <code>init(name:context:)</code>, returns that name.
///   </li>
///   <li>
///     Otherwise, returns the class name by default.
///   </li>
/// </ul>
@property (nonatomic, readonly, copy) NSString * _Nonnull name;
@property (nonatomic, readonly, copy) NSDictionary<NSString *, id> * _Nullable context;
...
@property (nonatomic, readonly, copy) NSArray<NSString *> * _Nullable contextList;
...
SWIFT_ENUM_FWD_DECL(NSInteger, ErrorType)
@class NSError;
...
SWIFT_CLASS("_TtC15BlueConicClient8BCResult")
@interface BCResult : NSObject
@property (nonatomic, readonly) BOOL success;
@property (nonatomic, readonly, strong) BCError * _Nullable error;
- (nonnull instancetype)initWithSuccess:(BOOL)success error:(BCError * _Nullable)error OBJC_DESIGNATED_INITIALIZER;
- (BCResult * _Nonnull)onSuccess:(void (^ _Nonnull)(void))closure;
- (BCResult * _Nonnull)onFailure:(void (^ _Nonnull)(BCError * _Nonnull))closure;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
///
/// \param callback optional closure invoked after initialization completes, receiving a <code>Callback</code> object with the result or the process
///
...
///
/// returns:
/// A <code>BCResult</code> object indicating success or failure.
- (void)initializeAsync:(BlueConicConfiguration * _Nonnull)configuration completionHandler:(void (^ _Nonnull)(BCResult * _Nonnull))completionHandler;
...
- (Profile * _Nonnull)getProfile SWIFT_WARN_UNUSED_RESULT;
...
///
- (void)createProfile:(void (^ _Nullable)(Callback * _Nonnull))callback;
/// Clears the profile ID from the BlueConic client locally (cache). A new profile ID will be generated.
///
/// returns:
/// A <code>BCResult</code> object indicating success or failure.
- (void)createProfileAsyncWithCompletionHandler:(void (^ _Nonnull)(BCResult * _Nonnull))completionHandler;
...
/// \param callback The callback function containing information about the operation.
///
- (void)deleteProfile:(void (^ _Nullable)(Callback * _Nonnull))callback;
/// Removes the profile from the BlueConic servers. The profile ID will be removed from the BlueConic client. A new profile ID will be generated.
///
/// returns:
/// A <code>BCResult</code> object indicating success or failure.
- (void)deleteProfileAsyncWithCompletionHandler:(void (^ _Nonnull)(BCResult * _Nonnull))completionHandler;
/// Update the profile to sync over the data from the Mobile app to the BlueConic servers
/// and; also pull in the data that has changed on the BlueConic side.
/// \param callback The callback function containing information about the operation.
///
...
/// returns:
/// A <code>BCResult</code> object indicating success or failure.
- (void)updateProfileAsyncWithCompletionHandler:(void (^ _Nonnull)(BCResult * _Nonnull))completionHandler;
...
///     return nil
/// }
/// await client.setMobileAdIdAsync(ASIdentifierManager.shared().advertisingIdentifier.uuidString)
/// </pre>
/// \param mobileAdId The Mobile Ad ID for that give device (IDFA).
///
///
/// returns:
/// A <code>BCResult</code> object indicating success or failure.
- (void)setMobileAdIdAsync:(NSString * _Nullable)mobileAdId completionHandler:(void (^ _Nonnull)(BCResult * _Nonnull))completionHandler;
...
/// </pre&gt:
/// \param isEnabled value that determines whether BlueConic functionality is enabled.
///
...
/// returns:
/// A <code>BCResult</code> object indicating success or failure.
- (void)createPageViewEventAsyncWithScreenName:(NSString * _Nonnull)screenName properties:(NSDictionary<NSString *, id> * _Nonnull)properties completionHandler:(void (^ _Nonnull)(BCResult * _Nonnull))completionHandler;
...
/// returns:
/// A <code>BCResult</code> object indicating success or failure.
- (void)createViewEventAsyncWithInteractionId:(NSString * _Nonnull)interactionId properties:(NSDictionary<NSString *, id> * _Nonnull)properties completionHandler:(void (^ _Nonnull)(BCResult * _Nonnull))completionHandler;
...
/// returns:
/// A <code>BCResult</code> object indicating success or failure.
- (void)createConversionEventAsyncWithInteractionId:(NSString * _Nonnull)interactionId properties:(NSDictionary<NSString *, id> * _Nonnull)properties completionHandler:(void (^ _Nonnull)(BCResult * _Nonnull))completionHandler;
...
/// returns:
/// A <code>BCResult</code> object indicating success or failure.
- (void)createClickEventAsyncWithInteractionId:(NSString * _Nonnull)interactionId properties:(NSDictionary<NSString *, id> * _Nonnull)properties completionHandler:(void (^ _Nonnull)(BCResult * _Nonnull))completionHandler;
...
/// <pre>
/// // Swift:
/// await client.createEventAsync(&quot;CUSTOMEVENT&quot;, data: [&quot;context&quot;: self._context.getInteractionId()])
/// </pre>
/// // Swift:
/// let contextArray = ["tennis", "soccer"]
/// await client.createEventAsync("CUSTOMEVENT", data:contextArray)
/// \param eventType The event type. (e.g: "PAGEVIEW", "VIEW", "CLICK", "CONVERSION")
///
/// \param data A map with data for the event.
///
...
/// returns:
/// A <code>BCResult</code> object indicating success or failure.
- (void)createEventAsync:(NSString * _Nonnull)eventType data:(NSDictionary<NSString *, id> * _Nullable)data completionHandler:(void (^ _Nonnull)(BCResult * _Nonnull))completionHandler;
/// Registers an event of the specified type with the given properties. For a "PAGEVIEW" event a screen name can be
/// passed, so interactions can be restricted on the where tab in BlueConic.
/// For a "VIEW", "CLICK" or "CONVERSION" event an interactionId should be passed to register the event for.
/// <h4>Example</h4>
...
/// <pre>
/// // Swift:
/// await client.createEventAsync(&quot;PAGEVIEW&quot;, properties: [&quot;screenName&quot;: &quot;Main/HOMETAB&quot;])
/// await client.createEventAsync(&quot;CLICK&quot;, properties: [&quot;interactionId&quot;: self._context.getInteractionId()])
/// </pre>
/// \param eventType The event type. (e.g: "PAGEVIEW", "VIEW", "CLICK", "CONVERSION")
///
/// \param properties A map with properties for the event.
...
/// returns:
/// A <code>BCResult</code> object indicating success or failure.
- (void)createEventAsync:(NSString * _Nonnull)eventType properties:(NSDictionary<NSString *, NSString *> * _Nullable)properties completionHandler:(void (^ _Nonnull)(BCResult * _Nonnull))completionHandler;
...
/// returns:
/// A <code>BCResult</code> object indicating success or failure.
- (void)createTimelineEventAsync:(NSString * _Nonnull)eventType eventDate:(NSDate * _Nonnull)eventDate properties:(NSDictionary<NSString *, id> * _Nonnull)properties completionHandler:(void (^ _Nonnull)(BCResult * _Nonnull))completionHandler;
/// Registers an event on the timeline of the profile with the given properties.
/// Note that when using this method, the ID of the timeline event will be an automatically generated UUID.
...
/// returns:
/// A <code>BCResult</code> object indicating success or failure.
- (void)createTimelineEventByIdAsync:(NSString * _Nonnull)eventId eventType:(NSString * _Nonnull)eventType eventDate:(NSDate * _Nonnull)eventDate properties:(NSDictionary<NSString *, id> * _Nonnull)properties completionHandler:(void (^ _Nonnull)(BCResult * _Nonnull))completionHandler;
...
/// returns:
/// A <code>BCResult</code> object indicating success or failure.
- (void)createRecommendationEventAsyncWithStoreId:(NSString * _Nonnull)storeId action:(NSString * _Nonnull)action itemIds:(NSArray<NSString *> * _Nonnull)itemIds completionHandler:(void (^ _Nonnull)(BCResult * _Nonnull))completionHandler;
...
/// </pre&gt:
/// \param className The class type of the plugin to register.
///
/// \param pluginClass The  class of the plugin.
///
...
///
/// \param onlyOnce A Boolean indicating if the listener triggers only once.
///
/// \param identifier A UUID for the listener that subscribed
///
...
/// Publishes an ADVANCED event with the given event name and context.
/// \param eventName The event name.
///
/// \param context The list of context elements.
///
...
/// returns:
/// A <code>BCResult</code> object indicating success or failure.
- (void)publishAdvancedEventAsyncWithEventName:(NSString * _Nonnull)eventName context:(NSArray<NSString *> * _Nonnull)context completionHandler:(void (^ _Nonnull)(BCResult * _Nonnull))completionHandler;
...
/// returns:
/// A <code>BCResult</code> object indicating success or failure.
- (void)publishClickEventAsyncWithSelector:(NSString * _Nonnull)selector context:(NSArray<NSString *> * _Nonnull)context completionHandler:(void (^ _Nonnull)(BCResult * _Nonnull))completionHandler;
...
/// returns:
/// A <code>BCResult</code> object indicating success or failure.
- (void)publishFormSubmitEventAsyncWithSelector:(NSString * _Nonnull)selector context:(NSArray<NSString *> * _Nonnull)context completionHandler:(void (^ _Nonnull)(BCResult * _Nonnull))completionHandler;
...
/// returns:
/// A <code>BCResult</code> object indicating success or failure.
- (void)publishUpdateContentEventAsyncWithSelector:(NSString * _Nonnull)selector content:(NSString * _Nonnull)content completionHandler:(void (^ _Nonnull)(BCResult * _Nonnull))completionHandler;
...
/// returns:
/// A <code>BCResult</code> object indicating success or failure.
- (void)publishUpdateValuesEventAsyncWithSelector:(NSString * _Nonnull)selector values:(NSArray<NSString *> * _Nonnull)values completionHandler:(void (^ _Nonnull)(BCResult * _Nonnull))completionHandler;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
- (void)onDestroy;
@required
- (NSArray<NSString *> * _Nonnull)getPreloadProperties SWIFT_WARN_UNUSED_RESULT;
@end
...
SWIFT_CLASS("_TtC15BlueConicClient7Profile")
...
/// returns:
/// A <code>BCResult</code> object indicating success or failure.
- (void)addConsentedObjectiveAsync:(NSString * _Nonnull)objectiveId completionHandler:(void (^ _Nonnull)(BCResult * _Nonnull))completionHandler;
...
/// returns:
/// A <code>BCResult</code> object indicating success or failure.
- (void)addRefusedObjectiveAsync:(NSString * _Nonnull)objectiveId completionHandler:(void (^ _Nonnull)(BCResult * _Nonnull))completionHandler;
...
/// returns:
/// A <code>BCResult</code> object indicating success or failure.
- (void)setConsentedObjectivesAsync:(NSArray<NSString *> * _Nonnull)objectiveIds completionHandler:(void (^ _Nonnull)(BCResult * _Nonnull))completionHandler;
...
/// returns:
/// A <code>BCResult</code> object indicating success or failure.
- (void)setRefusedObjectivesAsync:(NSArray<NSString *> * _Nonnull)objectiveIds completionHandler:(void (^ _Nonnull)(BCResult * _Nonnull))completionHandler;
@end
